...
extension Palette {
    static let mist = Palette(.mist) { tint in
        ...
        case .rimDispersion: Ramp(
            light: OKLCH(0.700, 0.075, 196, alpha: 0.28), dark: OKLCH(0.800, 0.070, 196, alpha: 0.40)
        )
        ...
        case .inkSecondary: Ramp(
            light: OKLCH(0.395, 0.018, 250), dark: OKLCH(0.885, 0.012, 235),
            lightHC: OKLCH(0.330, 0.018, 250), darkHC: OKLCH(0.935, 0.010, 235)
        )
        case .inkTertiary: Ramp(
            light: OKLCH(0.483, 0.016, 250), dark: OKLCH(0.760, 0.014, 235),
            lightHC: OKLCH(0.425, 0.016, 250), darkHC: OKLCH(0.820, 0.012, 235)
        )
        ...
        /// 那一档它本来就够亮了，深的是浅色档。
        case .focusRing: Ramp(
            light: OKLCH(0.600, 0.088, 196), dark: OKLCH(0.780, 0.058, 196),
